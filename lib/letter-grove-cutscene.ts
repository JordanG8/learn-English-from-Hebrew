...
export const LETTER_GROVE_CUTSCENE_BEATS = [
  ...
  },
  {
    ...
    textHe:
      "לכל אות באנגלית יש צליל משלה. בחרו את הצליל הנכון, והקסם שלכם ידליק רונה אחת!",
    durationHintMs: 7_000,
    sigil: "A",
  },
  {
    ...
    titleHe: "המשימה שלכם",
    textHe:
      "הדליקו את כל שלוש הרונות, פזרו את הערפל ועזרו לפופ. כשתצליחו, שרביט החורשה יהיה שלכם!",
    durationHintMs: 7_500,
    sigil: "✧",
  },
